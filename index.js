...
import {getData,updatedData} from "./routes/personal.js";
...
app.patch("/personal/image",uploadImage.single("image"),(req,res)=>{res.json({"message":"image uploaded successfully"})})
app.patch("/personal/cv",uploadCv.single("cv"),(req,res)=>{res.json({"message":"cv uploaded successfully"})})
